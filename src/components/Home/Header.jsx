            ...
            <div className="container mx-auto flex justify-between items-center font-bold text-gray-800" >
                <div className="flex justify-between items-center gap-6">
                    <Link to="/">
                        ...
                        <p className="text-violet-700 hover:text-violet-800 text-3xl transition font-dancing">PrimeStay</p>
                    </Link>
                ...
                <div className="flex items-center gap-6 ">
                    ...
                    <Link className="bg-violet-700 hover:bg-violet-800 text-white px-4 py-3 rounded-lg transition " to="">Post an ad</Link>
                </div>
